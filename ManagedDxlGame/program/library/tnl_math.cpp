...
namespace tnl {
    ...
    //--------------------------------------------------------------------------------------------------------------------------------
    // ÉÅÉãÉZÉìÉkÉcÉCÉXÉ^Å[ÇégópÇµÇΩóêêîê∂ê¨(float)
    float GetRandomDistributionFloat(float min, float max) 
    {
        // 0.0f Å` 1.0f ÇÃîÕàÕÇÃóêêîÇê∂ê¨
    ...
    // ÉÅÉãÉZÉìÉkÉcÉCÉXÉ^Å[ÇégópÇµÇΩóêêîê∂ê¨(int)
    ...
    //--------------------------------------------------------------------------------------------------------------------------------
    // work... ì_Ç∆ïΩñ ÇÃïΩñ è„Ç…ë∂ç›Ç∑ÇÈç≈ãﬂì_
    // arg2... ì_ç¿ïW
    // arg3... ïΩñ ÇÃñ@ê¸
    // arg4... ïΩñ è„ÇÃç¿ïW
